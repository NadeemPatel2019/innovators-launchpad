  ...
  return (
    <SiteLayout>
      ...
      <div className="container-wide py-16 lg:py-20">
        <section id="registered-non-profit" className="scroll-mt-40 lg:scroll-mt-44">
        ...
        <section id="wcia-news" className="scroll-mt-40 mt-10 lg:scroll-mt-44">
          <FadeInInView className="rounded-3xl border border-border bg-card p-6 shadow-card lg:p-8">
