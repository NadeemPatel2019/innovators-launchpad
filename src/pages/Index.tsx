...
const stats = [
  ...
  { value: "100+", label: "Toys adapted" },
  { value: "150+", label: "Community volunteers" },
  { value: "7", label: "Adapt-a-Thons hosted" },
];
    ...
    <SiteLayout>
        ...
        <div className="grid gap-10 lg:grid-cols-[1fr_1.4fr] lg:gap-16">
          <div>
            ...
            <p className="mt-5 text-lg text-muted-foreground">
              We integrate user-centered design and hands-on programming to address gaps in medical
              training and bring assistive technology directly to the families who need it.
            </p>
          </div>
          <div className="grid gap-5 sm:grid-cols-2">
            {pillars.map((p) => (
              <div
                key={p.title}
                className="group rounded-2xl border border-border bg-card p-6 shadow-card transition hover:-translate-y-0.5 hover:shadow-elevated"
              >
      ...
      <section className="bg-brand-navy text-primary-foreground">
        <div className="container-wide py-20">
          ...
          <div className="mt-12 grid gap-px overflow-hidden rounded-2xl bg-primary-foreground/15 sm:grid-cols-2 lg:grid-cols-4">
            {stats.map((s) => (
      ...
      <section className="container-wide pb-20">
        <div className="relative overflow-hidden rounded-3xl bg-gradient-accent p-10 text-accent-foreground shadow-elevated lg:p-14">
          <div
            aria-hidden
